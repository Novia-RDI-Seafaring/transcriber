...
from interview_transcriber.audio_utils import get_wav_path
import os, re
...
def identify_speakers(audio_path):
    ...
    speaker_clips = generate_speaker_clips_from_diarization(diarization, audio_path);
...
def generate_speaker_clips_from_diarization(diarization_output, audio_path):
