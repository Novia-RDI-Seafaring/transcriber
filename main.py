...
def main(audio_file_path, output_file_path, context_file_path=None, use_local=False, language=None):
    ...
    subtitle_data, embeddings, speakers, k, kluster_labels, embeddings_umap = identify_speakers(audio_file_path, context_string=context_string, use_local=use_local, language=language)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--language', type=str, help='The transcript shall be in this language', default=None)
    parser.add_argument('--use_local', action='store_true', help="Use local whisper")

    args = parser.parse_args()
    main(args.audio_file_path, args.output_file_path, args.context_file_path, args.use_local, args.language)
